...
public function store_ajax(Request $request)
{
    $rules = [
        ...
        'penjualan_id' => 'nullable|exists:t_penjualan,penjualan_id',
    ...
    // Auto-generate kode jika stok masuk
    if ($request->jenis == 'masuk' && empty($request->keterangan)) {
        $data['keterangan'] = 'Stok Masuk - ' . date('d/m/Y');
    }
    ...
    if ($request->jenis == 'masuk') {
        $barang->increment('stok', $request->stok_jumlah);
    } else {
        $barang->decrement('stok', $request->stok_jumlah);
    }
