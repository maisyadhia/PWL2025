...
<meta name="transaksi-list-url" content="{{ route('transaksi.list') }}">
...
<script>
    ...
    const transaksiListUrl = document.querySelector('meta[name="transaksi-list-url"]').content;
    var dataTransaksi;
    ...
    dataTransaksi = $('#datatable-transaksi').DataTable({
        ...
        ajax: {
            ...
            data: {
                _token: "{{ csrf_token() }}",
                transaksi_filter: $('#transaksi_filter').val()
            }
        },
        columns: [
